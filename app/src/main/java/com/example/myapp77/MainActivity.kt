...
class MainActivity : AppCompatActivity(), FragmentAction, FragmentAction2, FragmentAction3,
    FragmentAction4,
...
//// Отдельные карточки
    ...
    override fun action10(item: Int) {
    ...
    override fun action11(item: Int) {
